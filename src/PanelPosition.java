...
public class PanelPosition extends JPanel {
	...
	{
		return ((SpinnerNumberModel)spinnerLongitude.getModel()).getNumber().doubleValue();
	}
	
	public double latitud()
	{
		return ((SpinnerNumberModel)spinnerLatitude.getModel()).getNumber().doubleValue();
	}
	...
	public PanelPosition()
	{
        ...
        SpinnerModel modelLatitude = 
        	new SpinnerNumberModel(40.0, //initial value
